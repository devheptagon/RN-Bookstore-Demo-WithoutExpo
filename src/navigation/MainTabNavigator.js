...
SearchStack.navigationOptions = {
  ...
  tabBarIcon: ({ focused }) => (<TabBarIcon focused={focused} name={IconNames.Home} />),
}
...
FavouritesStack.navigationOptions = {
  ...
  tabBarIcon: ({ focused }) => (<TabBarIcon focused={focused} name={IconNames.FullHeart} />),
}
...
RecentsStack.navigationOptions = {
  ...
  tabBarIcon: ({ focused }) => (<TabBarIcon focused={focused} name={IconNames.Recents} />),
}
