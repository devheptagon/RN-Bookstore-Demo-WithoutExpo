...
const RegularView = ({ children, style, justifyContent, alignItems, centerAll, ...rest }) => {
    ...
    if (centerAll) {
        styleValue = { ...styleValue, justifyContent: FlexAlign.Center, alignItems: FlexAlign.Center }
    }
