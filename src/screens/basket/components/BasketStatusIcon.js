...
const BasketStatusIcon = (props) => <TouchableHighlight onPress={props.onPress}>
    <FlexView flexDirection={FlexDirections.Row}>
        {
            props.itemCount 
                ? <Badge value={props.itemCount} status="error" badgeStyle={styles.Badge} /> 
                : null
        }
        <Icon
            name={IconNames.BasketStatus}
            size={25}
