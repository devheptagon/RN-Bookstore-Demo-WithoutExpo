...
export const ProductInfo = (props) => {
    ...
    return (
        <FlexView flexDirection={props.isDetailed ? FlexDirections.Column : FlexDirections.Row}>
            <FlexView>
                <ProductImage calculateActualSize={props.isDetailed} imageLinks={imageLinks} />
            </FlexView>
            <FlexView flex={props.isDetailed ? 1 : 3} style={styles.InfoField}>
                <ScrollView>
                    <ProductMetaInfo dataItem={props.dataItem} isDetailed={props.isDetailed} />
                </ScrollView>
            </FlexView>
        </FlexView>
    )
