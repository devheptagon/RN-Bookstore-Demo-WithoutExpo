...
import { setMainNavigatorAction, setPageTitleAction } from '../../redux/appActions'
import { setFilter, fetchPage, refresh } from '../../services/repos/productRepo'
...
export class HomeScreen extends React.Component {
  ...
  componentDidMount() {
    const {mainNavigator, setMainNavigator, setPageTitle, navigation} = this.props
